...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "CerebrumFHEVM_v09",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.CerebrumFHEVM_v09__factory>;
    getContractFactory(
      name: "ICerebrumRiskScoring",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.ICerebrumRiskScoring__factory>;
    getContractFactory(
      name: "CerebrumRiskScoring",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.CerebrumRiskScoring__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.CerebrumFHEVM_v09>;
    getContractAt(
      name: "ICerebrumRiskScoring",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.ICerebrumRiskScoring>;
    getContractAt(
      name: "CerebrumRiskScoring",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.CerebrumRiskScoring>;
